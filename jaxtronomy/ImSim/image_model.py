...
from jaxtronomy.ImSim.differential_extinction import DifferentialExtinction
...
class ImageModel(object):
    ...
    def __init__(self, data_class, psf_class, lens_model_class=None,
                 ...
                 kwargs_numerics=None, kwargs_pixelbased=None):
        """
        ...
        # self.PointSource.update_search_window(search_window=max(self.Data.width), x_center=x_center,
    ...
    def _source_surface_brightness_analytical(self, kwargs_source,
                                              kwargs_lens=None,
    ...
    def _source_surface_brightness_pixelbased(self, kwargs_source,
                                              kwargs_lens=None,
                                              kwargs_extinction=None,
                                              kwargs_special=None,
                                              unconvolved=False,
    ...
    def image(self, kwargs_lens=None, kwargs_source=None,
              kwargs_lens_light=None, kwargs_ps=None, kwargs_extinction=None,
              kwargs_special=None, unconvolved=False, source_add=True,
