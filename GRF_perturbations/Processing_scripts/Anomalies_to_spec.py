...
if __name__ == '__main__':
    ...
    for node_index in nodes_array:
        ...
        for batch_index in Batches_array:
            anomalies_grid=np.load('../Processing_scripts/results/Anomalies/anomalies_grid_node_{:.0f}_batch_{:.0f}.npz'.format(node_index,batch_index))['arr_0']
