...
class MassSensitivityMapping(object):
    ...
    def sensitivity_map(self, init_mass=0., x_grid=None, y_grid=None, use_jax_vectorize=False):
    ...
    def prepare_halo_model(self, init_mass):
        ...
        halo_lens_model_list = [self.halo_profile] + self.m_lens_image.LensModel.lens_model_list
